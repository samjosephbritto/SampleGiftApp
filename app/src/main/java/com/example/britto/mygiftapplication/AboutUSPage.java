...
public class AboutUSPage extends Activity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        webView = (WebView)findViewById(R.id.aboutusweb);
        ...
        webView.loadUrl(GiftingUrls.aboutusurl);
    }
    public class WebBrowser extends WebViewClient {

        private ProgressDialog progressDialog = new ProgressDialog(AboutUSPage.this);
        @Override
